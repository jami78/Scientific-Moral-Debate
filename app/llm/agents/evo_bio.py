...
class EvoBioAgent:
    def __init__(self):
        self.model = llm
        self.prompt = self.get_prompt("EVOLUTIONARY_BIOLOGIST_PROMPT")
    ...
    def evobio_opinion(self,node_prompt, state: AgentState, node:str) -> AgentState:
